            ...
            <div class="footer__wrapper flex  justify-between">
                <div class="footer__navigations flex  justify-between text-center md:text-left">
                    <div class="footer__pages flex-1 ">
                        <p class="font-bold reveal">Pages</p>
                    ...
                    <div class="footer__tomothy flex-1 ">
                        <p class="font-bold reveal">Tomothy</p>
                        <ul class="footer__tomothy-menu">
                            <li class="reveal">
                                <NuxtLink>Eleanor Edwards</NuxtLink>
                            </li>
                            <li class="reveal">
                                <NuxtLink>Ted Robertson</NuxtLink>
                            </li>
                            <li class="reveal">
                                <NuxtLink>Annette Russell</NuxtLink>
                            </li>
                            <li class="reveal">
                                <NuxtLink>Jennie Mckinney</NuxtLink>
                            </li>
                            <li class="reveal">
                                <NuxtLink>Gloria Richards</NuxtLink>
                            </li>
                        </ul>
                    </div>
                    <div class="footer__jane-black flex-1 ">
                        <p class="font-bold reveal">Jane black</p>
                        <ul class="footer__jane-black-menu">
                            <li class="reveal">
                                <NuxtLink>Philip Jones</NuxtLink>
                            </li>
                            <li class="reveal">
                                <NuxtLink>Product</NuxtLink>
                            </li>
                            <li class="reveal">
                                <NuxtLink>Colleen Russell</NuxtLink>
                            </li>
                            <li class="reveal">
                                <NuxtLink>Marvin Hawkins</NuxtLink>
                            </li>
                            <li class="reveal">
                                <NuxtLink>Bruce Simmmons</NuxtLink>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="footer__contact">
                    <div class="reveal footer__contact-mail flex items-center">
                        ...
                        <p class="pl-2.5">7480 Mockingbird Hill undefined</p>
                    </div>
                    <div class=" reveal footer__contact-tel flex items-center">
                        ...
                        <p class="pl-2.5">(239) 555-0108</p>
                    </div>
                    <div class="footer__contact-network flex pt-9">
